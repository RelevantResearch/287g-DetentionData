...
#     pivot_dir = os.path.join(output_dir, 'Pivot PendingAgencies')
#     os.makedirs(pivot_dir, exist_ok=True)

#     # Write to Excel
#     # pivot_output_path = os.path.join(pivot_dir, f"pivot-{filename}")
#     pivot_output_path = os.path.join(output_dir, f"pivot-{filename.replace('Total-', '')}")
#     with pd.ExcelWriter(pivot_output_path, engine='xlsxwriter') as writer:
...
#     total_pending_dir = os.path.join(base_dir, 'Total pendingAgencies')
...
#         else:
#             print(f"❌ File not found: {total_file_name} in 'Total pendingAgencies'")
#     else:
